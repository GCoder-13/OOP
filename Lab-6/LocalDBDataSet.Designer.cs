...
namespace Lab_6 {
    ...
    public partial class LocalDBDataSet : global::System.Data.DataSet {
        ...
        public partial class DrinksDataTable : global::System.Data.TypedTableBase<DrinksRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public DrinksRow AddDrinksRow(string name) {
...
namespace Lab_6.LocalDBDataSetTableAdapters {
    ...
    public partial class DrinksTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Drinks] ([name]) VALUES (@name);\r\nSELECT Id, name FROM Drinks " +
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Drinks] SET [name] = @name WHERE (([Id] = @Original_Id) AND ([name]" +
                " = @Original_name));\r\nSELECT Id, name FROM Drinks WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Lab_6.Properties.Settings.Default.LocalDBConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, name FROM dbo.Drinks";
        ...
        public virtual int Fill(LocalDBDataSet.DrinksDataTable dataTable) {
        ...
        public virtual LocalDBDataSet.DrinksDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            LocalDBDataSet.DrinksDataTable dataTable = new LocalDBDataSet.DrinksDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(LocalDBDataSet.DrinksDataTable dataTable) {
